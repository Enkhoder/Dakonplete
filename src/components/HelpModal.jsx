...
const capF = [
  { c: { p0: [0], p1: [], p2: [], o0: [], o1: [1, 2, 3], o2: [], st: [] }, hand: [], label: 'Own cup 1 has 1 seed; opposite has 3' },
  { c: { p0: [], p1: [], p2: [], o0: [], o1: [1, 2, 3], o2: [], st: [] }, hand: [0], label: 'Pick up from own cup 1' },
  { c: { p0: [], p1: [0], p2: [], o0: [], o1: [1, 2, 3], o2: [], st: [] }, hand: [], label: 'Lands on empty own cup!', hl: { p1: 'green', o1: 'red' } },
  { c: { p0: [], p1: [], p2: [], o0: [], o1: [], o2: [], st: [0, 1, 2, 3] }, hand: [], label: 'Capture! All seeds → your store', hl: { st: 'green' } },
];
  ...
  return (
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-6">
      <div className="bg-white border-3 border-black shadow-[6px_6px_0_#000] max-w-xl w-full max-h-[85vh] flex flex-col relative">
        ...
        {/* Header — outside scroll container, completely immune to scroll */}
        ...
        {/* Custom fade-out scrollbar overlay */}
